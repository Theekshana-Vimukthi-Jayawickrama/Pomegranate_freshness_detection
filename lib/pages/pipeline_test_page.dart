...
//       WidgetsBinding.instance.addPostFrameCallback((_) {
//         if (mounted) {
//           ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Model load error: $msg')));
//         }
//       });
//     }
//   }
...
//       appBar: AppBar(
//         elevation: 0,
//         automaticallyImplyLeading: false, // We'll handle drawer icon manually
//         flexibleSpace: Container(
//           decoration: BoxDecoration(
//             gradient: LinearGradient(
//               colors: [pomegranateRed, pomegranateSeed],
...
//               onPressed: loading ? null : _resetToHome,
//               tooltip: 'Home',
//             ),
...
//                   if (_showTip) const AnimatedUsageTip(),

//                   const SizedBox(height: 20),

//                   if (loading && imageBytes != null)
//                     Container(
//                       padding: const EdgeInsets.all(24),
//                       decoration: BoxDecoration(
//                         color: Colors.white,
...
// // AnimatedUsageTip remains unchanged
// class AnimatedUsageTip extends StatefulWidget {
//   const AnimatedUsageTip({super.key});
...
class _PipelineTestPageState extends State<PipelineTestPage>
  ...
  // ✅ FIXED: Request correct permission based on Android version
  Future<bool> _requestPermission(ImageSource source) async {
    late Permission permission;
    String permissionType = '';
    ...
    if (source == ImageSource.camera) {
      ...
      if (Platform.isAndroid) {
        ...
        if (androidInfo.version.sdkInt >= 33) {
          ...
          permission = Permission.storage;  // Android 12 and below → READ_EXTERNAL_STORAGE
          permissionType = 'Storage';
        }
      } else {
        // iOS always uses photos
